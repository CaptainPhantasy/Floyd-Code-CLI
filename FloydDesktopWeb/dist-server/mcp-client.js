...
export const BUILTIN_TOOLS = [
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                files: { type: 'string', description: 'Files to stage (e.g., "." for all, or specific paths)' },
                cwd: { type: 'string', description: 'Working directory' },
            },
            required: ['files'],
        },
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                branch: { type: 'string', description: 'Branch or file to checkout' },
                cwd: { type: 'string', description: 'Working directory' },
            },
            required: ['branch'],
        },
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                key: { type: 'string', description: 'Unique key for this pattern' },
                pattern: { type: 'string', description: 'Pattern description and code' },
                tier: { type: 'string', enum: ['project', 'vault'], description: 'Cache tier' },
            },
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                key: { type: 'string', description: 'Unique key for this reasoning' },
                reasoning: { type: 'string', description: 'Reasoning content' },
            },
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                key: { type: 'string', description: 'Key of reasoning to load' },
            },
            required: ['key'],
        },
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                key: { type: 'string', description: 'Key of reasoning to archive' },
            },
            required: ['key'],
        },
    },
    // === PATCH OPERATIONS ===
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                basePath: { type: 'string', description: 'Base path for patch' },
            },
            required: ['diff'],
        },
    },
    ...
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                diff: { type: 'string', description: 'Unified diff to analyze' },
            },
            required: ['diff'],
        },
    },
    // === SPECIAL OPERATIONS ===
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                type: { type: 'string', enum: ['file_exists', 'file_contains', 'command_succeeds', 'test_passes'], description: 'Verification type' },
                path: { type: 'string', description: 'File/path to verify' },
                content: { type: 'string', description: 'Expected content (for file_contains)' },
                command: { type: 'string', description: 'Command to run (for command_succeeds)' },
            },
            required: ['type'],
        },
    },
    {
        ...
        inputSchema: {
            type: 'object',
            properties: {
                changes: { type: 'array', items: { type: 'object' }, description: 'Array of change objects' },
                testCommand: { type: 'string', description: 'Command to verify changes' },
            },
            required: ['changes'],
        },
    },
