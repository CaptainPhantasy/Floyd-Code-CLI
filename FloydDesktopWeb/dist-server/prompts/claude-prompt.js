...
export function buildClaudeSystemPrompt(config = {}) {
    const { agentName = 'Claude', workingDirectory = process.cwd(), projectContext = null, maxTurns = 20, enableChainOfThought = true, } = config;
    const identity = `
