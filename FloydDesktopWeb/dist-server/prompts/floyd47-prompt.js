...
export function buildFloyd47SystemPrompt(config = {}) {
    const { agentName = 'Floyd 4.7', workingDirectory = process.cwd(), projectContext = null, maxTurns = 20, disableReasoning = false, enablePreservedThinking = true, } = config;
    const mainPrompt = `
